...
describe("Clock", () => {
  ...
  describe("Compare two clocks for equality", () => {
    ...
    describe("test pro Ismael", () => {
      const baseClock = new Clock(1, 0);
      const aClock = baseClock.plus(60);
      const bClock = baseClock.minus(60);

      test("la porra toda", () => {
        expect(aClock.toString()).toEqual("02:00");
        expect(bClock.toString()).toEqual("00:00");
      });
    });
  });
});
